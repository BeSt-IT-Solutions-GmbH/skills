...
A collection of agent skills (slash commands and behaviors) for GitHub Copilot CLI (and compatible agents). Skills are organized into buckets and consumed by per-repo configuration emitted by `/setup-matt-pocock-skills`.
