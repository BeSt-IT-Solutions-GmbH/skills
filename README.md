...
- [`/grill-me`](./plugins/skills/skills/productivity/grill-me/SKILL.md) - for non-code uses
- [`/grill-with-docs`](./plugins/skills/skills/engineering/grill-with-docs/SKILL.md) - same as [`/grill-me`](./plugins/skills/skills/productivity/grill-me/SKILL.md), but adds more goodies (see below)
...
This is built into [`/grill-with-docs`](./plugins/skills/skills/engineering/grill-with-docs/SKILL.md). It's a grilling session, but that helps you build a shared language with the AI, and document hard-to-explain decisions in ADR's.
...
- **[grill-with-docs](./plugins/skills/skills/engineering/grill-with-docs/SKILL.md)** — Grilling session that challenges your plan against the existing domain model, sharpens terminology, and updates `CONTEXT.md` and ADRs inline.
- **[triage](./plugins/skills/skills/engineering/triage/SKILL.md)** — Triage issues through a state machine of triage roles.
...
- **[setup-matt-pocock-skills](./plugins/skills/skills/engineering/setup-matt-pocock-skills/SKILL.md)** — Scaffold the per-repo config (issue tracker, triage label vocabulary, domain doc layout) that the other engineering skills consume. Run once per repo before using `to-issues`, `to-prd`, `triage`, `diagnose`, `tdd`, `improve-codebase-architecture`, or `zoom-out`.
...
- **[to-prd](./plugins/skills/skills/engineering/to-prd/SKILL.md)** — Turn the current conversation context into a PRD and submit it as a GitHub issue. No interview — just synthesizes what you've already discussed.
...
- **[prototype](./plugins/skills/skills/engineering/prototype/SKILL.md)** — Build a throwaway prototype to flesh out a design — either a runnable terminal app for state/business-logic questions, or several radically different UI variations toggleable from one route.
...
- **[git-guardrails-claude-code](./plugins/skills/skills/misc/git-guardrails-claude-code/SKILL.md)** — Set up hooks to block dangerous git commands (push, reset --hard, clean, etc.) before they execute.
- **[migrate-to-shoehorn](./plugins/skills/skills/misc/migrate-to-shoehorn/SKILL.md)** — Migrate test files from `as` type assertions to @total-typescript/shoehorn.
- **[scaffold-exercises](./plugins/skills/skills/misc/scaffold-exercises/SKILL.md)** — Create exercise directory structures with sections, problems, solutions, and explainers.
- **[setup-pre-commit](./plugins/skills/skills/misc/setup-pre-commit/SKILL.md)** — Set up Husky pre-commit hooks with lint-staged, Prettier, type checking, and tests.
