...
### Misc (archived, not published)

Tools I keep around but rarely use. These are not part of the plugin and must be installed manually.

- **[git-guardrails-claude-code](./skills/misc/git-guardrails-claude-code/SKILL.md)** — Set up hooks to block dangerous git commands (push, reset --hard, clean, etc.) before they execute.
